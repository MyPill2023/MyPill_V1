...
public class NotProd {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            Order order = orderService.createFromProduct(memberUser1, 1L, 3L).getData();
            orderService.payByTossPayments(order, LocalDateTime.now(), "test1234", new AddressRequest(1L, "김철수", "서울특별시 중구 세종대로 110", "서울특별시청", "04524", "02-120", false));
        };
    }
}
